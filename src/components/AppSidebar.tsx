...
const navigationItems = [
  ...
  { title: "Scan for Anomalies", url: "/scan", icon: Search },
  { title: "Generate Content", url: "/generate", icon: FileText },
]
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild className="w-full">
              ...
              >
                ...
                {!collapsed && (
                  <span className="font-medium animate-fade-in">Settings</span>
                )}
              </NavLink>
            </SidebarMenuButton>
          </SidebarMenuItem>
